...
C_SRCS += \
../Core/Src/main.c \
../Core/Src/simple_neural_networks.c \
...
OBJS += \
./Core/Src/main.o \
./Core/Src/simple_neural_networks.o \
...
C_DEPS += \
./Core/Src/main.d \
./Core/Src/simple_neural_networks.d \
...
Core/Src/simple_neural_networks.o: ../Core/Src/simple_neural_networks.c
	arm-none-eabi-gcc "$<" -mcpu=cortex-m7 -std=gnu11 -g3 -DUSE_HAL_DRIVER -DSTM32F767xx -DDEBUG -c -I../Core/Inc -I../Drivers/STM32F7xx_HAL_Driver/Inc -I../Drivers/STM32F7xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32F7xx/Include -I../Drivers/CMSIS/Include -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Core/Src/simple_neural_networks.d" -MT"$@" --specs=nano.specs -mfpu=fpv5-d16 -mfloat-abi=hard -mthumb -o "$@"
